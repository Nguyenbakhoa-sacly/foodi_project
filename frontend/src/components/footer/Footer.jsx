      ...
      <div>
        <footer className="footer xl:px-24 py-10 px-4 text-base-content">
          ...
          <nav>
            ...
            <Link className="link link-hover">Offers</Link>
            <Link className="link link-hover">Menus</Link>
            <Link className="link link-hover">Reservation</Link>
          </nav>
          <nav>
            <header className="footer-title">Contact Us</header>
            <Link className="link link-hover">example@email.com</Link>
            <Link className="link link-hover">+64 958 248 966</Link>
            <Link className="link link-hover">Social media</Link>
          </nav>
        </footer>
        <hr />
