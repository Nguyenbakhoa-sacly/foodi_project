    ...
    <>
      ...
      <li tabIndex={0}>
        <details>
          ...
          <ul className="p-2">
            <li className='w-32'><Link to=''>Online Order</Link></li>
            <li className='w-32'><Link to=''>Table Booking</Link></li>
            <li className='w-32'><Link to=''>Order Tracking</Link></li>
          </ul>
        </details>
      </li>
      ...
      <div className={`navbar xl:px-24 ${isSticky ?
        ...
        <div className="navbar-end">
          ...
          <div tabIndex={0} role="button"
            className="btn btn-ghost btn-circle items-center justify-center md:flex hidden">
